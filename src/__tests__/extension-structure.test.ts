...
describe('Extension Structure', () => {
  ...
  // Skip all structure tests if dist/ doesn't exist (e.g., during CI before build)
  const describeIfDistExists = distExists ? describe : describe.skip;

  describeIfDistExists('dist folder', () => {
  ...
  describeIfDistExists('dist manifest.json', () => {
