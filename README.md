...
A Chrome extension that enhances Jira Plans (Advanced Roadmaps) with powerful productivity features. Start with engineer headcount tracking, with more features coming based on your feedback!

## 🎯 Features

### ✅ Active: Engineer Headcount Tracking (v0.1.0)
...
**Have an idea?** [Request a feature →](https://github.com/andreibirs/jira-plans-enhanced/issues)
...
Want to contribute a new feature? Check out [FEATURES.md](FEATURES.md) for the roadmap and architecture guidelines.
...
See [FEATURES.md](FEATURES.md) for planned features and architecture guidelines.
...
**Current version: v0.1.0** - Engineer headcount tracking

**Next up:**
- v0.2.0: Epic progress indicators
- v0.3.0: Capacity planning tools
- v0.4.0: Quick filters & search

See [FEATURES.md](FEATURES.md) for the complete roadmap.

**We listen to feedback!** The roadmap is flexible based on what users actually need.
...
- 💡 [Request a feature](https://github.com/andreibirs/jira-plans-enhanced/issues)
- 📖 [View roadmap](FEATURES.md)
